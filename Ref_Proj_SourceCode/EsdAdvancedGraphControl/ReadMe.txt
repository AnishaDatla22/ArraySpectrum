========================================================================
    ACTIVEX CONTROL DLL : AxWrapper1 Project Overview
========================================================================

ControlWizard has created this project for your AxWrapper1 ActiveX Control
...
that make up your AxWrapper1 ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CAxWrapper1Ctrl control:

AxWrapper1Ctrl.h
    This file contains the declaration of the CAxWrapper1Ctrl C++ class.

AxWrapper1Ctrl.cpp
    This file contains the implementation of the CAxWrapper1Ctrl C++ class.

AxWrapper1PropPage.h
    This file contains the declaration of the CAxWrapper1PropPage C++ class.

AxWrapper1PropPage.cpp
    This file contains the implementation of the CAxWrapper1PropPage C++ class.

CAxWrapper1Ctrl.bmp
    This file contains a bitmap that a container will use to represent the
    CAxWrapper1Ctrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file AxWrapper1.rc.
...
stdafx.h, stdafx.cpp
    ...
    named AxWrapper1.pch and a precompiled types (PCT) file named stdafx.obj.
